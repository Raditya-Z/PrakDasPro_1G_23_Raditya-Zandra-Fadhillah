...
public class MahasiswaDemo22 {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("6. Banyak Tugas Terkumpul");
            ...
            switch (pilih) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    Mahasiswa22 awal = stack.awal();
                    if (awal != null) {
                        System.out.println("Tugas pertama dikumpulkan oleh " + awal.nama);
                    }
                    break;
                case 6:
                    System.out.println("Banyak tugas yang terkumpul: " + stack.banyakTugas());
                    break;
                default:
